...
impl MediaPlayer {
    ...
    pub fn set_pause(&self, do_pause: bool) {
        unsafe {
            libvlc_sys::libvlc_media_player_set_pause(self.ptr, if do_pause { 1 } else { 0 })
        };
    }
    ...
    pub fn set_time(&self, time: i64) {
        unsafe {
            libvlc_sys::libvlc_media_player_set_time(self.ptr, time);
        }
    }
    ...
    pub fn set_position(&self, pos: f32) {
        unsafe {
            libvlc_sys::libvlc_media_player_set_position(self.ptr, pos);
        }
    }
    ...
    pub fn set_chapter(&self, chapter: i32) {
        unsafe {
            libvlc_sys::libvlc_media_player_set_chapter(self.ptr, chapter);
        }
    }
    ...
    pub fn set_title(&self, title: i32) {
        unsafe {
            libvlc_sys::libvlc_media_player_set_title(self.ptr, title);
        }
    }
    ...
    pub fn previous_chapter(&self) {
        unsafe {
            libvlc_sys::libvlc_media_player_previous_chapter(self.ptr);
        }
    }
    ...
    pub fn next_chapter(&self) {
        unsafe {
            libvlc_sys::libvlc_media_player_next_chapter(self.ptr);
        }
    }
    ...
    pub fn next_frame(&self) {
        unsafe {
            libvlc_sys::libvlc_media_player_next_frame(self.ptr);
        }
    }
    ...
    pub fn navigate(&self, navigate: u32) {
        unsafe {
            libvlc_sys::libvlc_media_player_navigate(self.ptr, navigate);
        }
    }
    ...
    pub fn set_video_title_display(&self, position: Position, timeout: u32) {
        unsafe {
            libvlc_sys::libvlc_media_player_set_video_title_display(
                self.ptr,
                position.into(),
                timeout,
            );
